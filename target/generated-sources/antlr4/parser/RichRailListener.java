...
public interface RichRailListener extends ParseTreeListener {
	...
	/**
	 * Enter a parse tree produced by {@link RichRailParser#option}.
	 * @param ctx the parse tree
	 */
	void enterOption(RichRailParser.OptionContext ctx);
	/**
	 * Exit a parse tree produced by {@link RichRailParser#option}.
	 * @param ctx the parse tree
	 */
	void exitOption(RichRailParser.OptionContext ctx);
	/**
